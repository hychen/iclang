...
*** Fire Rule
1. No data arrived, the process does not fire.
...
2. Only one data arrived to *in1*, port, the process does not fire.
...
3. All data arrived to *in1* and *in2* port, the process fires.
