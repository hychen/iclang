...
*** 特性
1. 所有的 HyperScript File 都包含 grammar 欄位，且其值為 iclang。
2. 所有的 HyperScript File 都包含 properties 欄位, procesess 欄位, connections 欄位。
3. inports, exports, comment 欄位為 optional。
*** 範例
